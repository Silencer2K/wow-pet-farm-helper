        ...
        from = {
            {
                ...
                raid_save_zone = 'Coilfang: Serpentshrine Cavern',
            },
        },
    },
    [97553] = { -- Tainted Core
        ...
        from = {
            {
                ...
                zone_id = 775,
                level = 70, for_sort = 141,
                raid_save_zone = 'The Battle for Mount Hyjal',
            },
        },
    },
        ...
        from = {
            {
                ...
                zone_id = 796,
                level = 70, for_sort = 141,
                raid_save_boss = 'Reliquary of Souls',
            },
        },
    },
        ...
        from = {
            {
                ...
                level = 70, for_sort = 159,
                raid_save_zone = 'The Sunwell',
                raid_save_boss = 'The Eredar Twins',
            },
            {
